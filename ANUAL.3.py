...
def calculate_annual_precipitation(input_dir):
    ...
    for file_name in os.listdir(input_dir):
        ...
        if os.path.isfile(file_path) and file_name.endswith(".dat"):
            ...
            for line in data_lines:
                ...
                monthly_precip = sum(valid_values) / valid_days  # Media correcta considerando valores válidos
    ...
    for year, monthly_averages in annual_precip.items():
        annual_total = sum(monthly_averages) * 12  # Ajuste considerando valores normalizados
